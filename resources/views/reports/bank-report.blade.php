...
<body>
    ...
    <div class="summary-box">
        <div class="summary-grid">
            <div class="summary-row">
                <div class="summary-label">Total Bank/GP Receipts</div>
                <div class="summary-value">Rs.  {{ number_format($totalReceipts, 2) }}</div>
            </div>
            <div class="summary-row">
                <div class="summary-label">Cash Deposited to Bank</div>
                <div class="summary-value">Rs.  {{ number_format($totalCashDeposits, 2) }}</div>
            </div>
            <div class="summary-row">
            ...
            <div class="summary-row balance">
                <div class="summary-label">Remaining Bank Balance</div>
    ...
    <div class="section">
        <div class="section-title">Bank/GP Receipts (Buyer Payments via Bank/GP Mode)</div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $receipt->landing && $receipt->landing->boat ? $receipt->landing->boat->name : '-' }}</td>
                    <td>{{ $receipt->mode }}</td>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr class="total-row">
                    ...
                    <td class="text-right">Rs.  {{ number_format($totalCashDeposits, 2) }}</td>
                    <td></td>
                </tr>
            </tbody>
        </table>
    ...
    <div class="section">
        <div class="section-title">Bank/GP Payments</div>
        <div style="overflow-x: auto;">
        <table>
            <thead>
                <tr>
