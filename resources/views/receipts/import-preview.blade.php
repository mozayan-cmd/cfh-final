...
<div class="card rounded-xl p-6 max-w-3xl mx-auto">
    ...
    <div class="bg-green-500/10 border border-green-500/30 rounded-lg p-4 mb-6">
        <p class="text-green-400">Ready to import <strong>{{ count($results) }}</strong> receipt(s)</p>
    </div>
    ...
    <form action="{{ route('receipts.import.process') }}" method="POST" class="mt-6">
        @csrf
        <div class="flex justify-between items-center">
            <a href="{{ route('receipts.import') }}" class="bg-gray-600 hover:bg-gray-700 text-off-black px-6 py-2 rounded-lg">
                Cancel
            </a>
